...
class OperationalTypeController extends Controller
{
    public function index() {
        $results = OperationalType::with('typeComplaints')->paginate(5);
        return $results;
    }
    ...
    public function store(Request $req) {
        ...
        if(!$result) {
            return response(['message' => Helper::defaultMessage('Operational Type')->CREATE_FAILED], 400);
        }

        return response(['message' => Helper::defaultMessage('Operational Type')->CREATE_SUCCESS], 200);
    }
    ...
    public function update(Request $req, $id) {
        ...
        return response(['message' => Helper::defaultMessage('Operational Type')->UPDATE_SUCCESS], 200);
    }
